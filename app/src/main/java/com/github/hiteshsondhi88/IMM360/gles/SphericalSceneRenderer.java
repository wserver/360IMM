package  com.github.hiteshsondhi88.IMM360.gles;
...
import  com.github.hiteshsondhi88.IMM360.filtermusic.Frag4_musicApply;
...
public class SphericalSceneRenderer {
    ...
    private  com.github.hiteshsondhi88.IMM360.gles.Sphere sphere;

    public SphericalSceneRenderer(Context context) {
        shaderProgram = new ShaderProgram(
                Frag4_musicApply.readRawTextFile(context, R.raw.video_vertex_shader),
                Frag4_musicApply.readRawTextFile(context, R.raw.video_fragment_shader));
