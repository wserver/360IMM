...
public class ThumbnailBuilder extends HttpAsyncTask {
    ...
    Bitmap mBitmap;
    final AlbumAdapter.selectedGalleryType mType; //Gallery type

    public ThumbnailBuilder(Context context, int bitmapId, int position, AlbumAdapter.selectedGalleryType type){
        super(null, null);
        mContext = context;
        mImageId = bitmapId;
        mPosition = position;
    ...
    protected Object doInBackground(Void... voids) {
        ...
        if (!isCancel) {
            if (mType.equals(AlbumAdapter.selectedGalleryType.DOWNLOAD_IMAGE))
            ...
            else if(mType.equals(AlbumAdapter.selectedGalleryType.DOWNLOAD_VIDEO))
